...
public class AccesoDatosImpl implements IAccesoDatos{
        ...
        try {
            ...
            while(linea != null){
                if(buscar != null && buscar.equalsIgnoreCase(linea)){
                    resultado = "Pelicula encontrada " +linea + "en elindice " + indice;
                    break;
                }
                linea = entrada.readLine();
                indice++;
            ...
            entrada.close();
             ...
             ex.printStackTrace();
            throw new LecturaDatosEx("Excepción al bucar la peliculas" + ex.getMessage());
        } catch (IOException ex) {
           ex.printStackTrace();
            throw new LecturaDatosEx("Excepción al bucar la peliculas" + ex.getMessage());
        }
    ...
    public void borrar(String nombreRecurso) throws AccesoDatosEx {
         ...
         System.out.println("Seha eliminado el archivo");
    }
